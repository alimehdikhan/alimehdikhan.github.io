    ...
    <section id="experience" className="relative py-16 sm:py-24 md:py-32 bg-bg-primary border-t border-border-dim" ref={containerRef}>
      <div className="container mx-auto px-4 sm:px-6 max-w-5xl">
        ...
        <div className="relative flex flex-col gap-10 md:gap-16">
          ...
          <div className="absolute left-5 sm:left-6 md:left-1/2 top-0 bottom-0 w-0.5 bg-border-dim md:-translate-x-1/2 z-0">
            <motion.div 
          ...
          {experiences.map((exp, idx) => {
            ...
            return (
              ...
              >
                {/* Visual marker dot */}
                <div className="absolute left-5 sm:left-6 md:left-1/2 w-3.5 h-3.5 rounded-full border-4 border-bg-primary bg-indigo-500 top-6 -translate-x-1/2 z-10 shadow-[0_0_12px_rgba(99,102,241,0.5)]" />
